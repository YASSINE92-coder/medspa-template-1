...
export default function PlannerPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-20 text-center">
      <span className="inline-block rounded-full bg-accent-soft text-accent text-sm font-medium px-4 py-1.5">
        {p.comingSoonLabel}
      </span>
      ...
      <form className="mt-10 flex gap-2 max-w-md mx-auto" aria-label={p.notifyLabel}>
        ...
        <button
          type="button"
          className="rounded-full bg-accent text-white text-sm font-medium px-6 py-3"
        >
          {p.notifyLabel}
        </button>
      </form>
