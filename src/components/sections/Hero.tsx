    ...
    <section className="relative overflow-hidden bg-accent-soft">
      ...
      <div className="relative mx-auto max-w-6xl px-4 pt-14 pb-16 md:pt-24 md:pb-24 grid items-center gap-10 md:gap-14 md:grid-cols-[1.05fr_0.95fr]">
        ...
        <div>
          ...
          <motion.h1
            {...fadeUp(0.08)}
            className="mt-5 text-4xl sm:text-5xl md:text-6xl font-semibold leading-[1.05] tracking-tight text-balance"
          >
            {c.headline}
          </motion.h1>

          {c.subheadline && (
            <motion.p {...fadeUp(0.16)} className="mt-5 max-w-md text-lg text-muted">
              {c.subheadline}
            </motion.p>
          )}
        ...
        >
          ...
          <motion.div
            ...
            className="absolute -bottom-4 left-4 rounded-2xl bg-surface/95 backdrop-blur px-5 py-3 shadow-lg ring-1 ring-ink/5"
          >
